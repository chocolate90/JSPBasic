...
<head>
	...
	<!-- 내부 스타일 시트는 style태그를 이용해서 디자인을 주는 방식이다. -->
	<!-- 태그에는 class속성이 존재하고 디자인을 줄 때 이 클래스를 선택하는 방법을 많이 사용한다. -->
	<!-- 클래스에 접근하는 선택자는 . 이다. -->
	<style>
		.form-content {width: 200px; margin: 0 auto;}
		.form-control {width: 100%; box-sizing: border-box; margin-top: 5px;}
...
<body>
	...
	<!-- 
		css는 html에 디자인을 입히는 언어이다.
		사용하는 형식으로는 인라인시트, 내부스타일시트, 외부스타일시트가 있다.
	 -->
	<section>
